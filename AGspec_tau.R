...
#####tau vs exp######
#load table from Leader et al 2018, showing expression of genes accross different tissues in D mel
tau_df=read.delim(file="/Users/loganblair/Desktop/seq/gene_tab_files/FlyAtlas_data_table", sep='\t', header=T)
...
options(scipen=1)
ggplot(tau_df1, aes(y=RNA_mean+1, x=tau, color=AG_enriched))+
...
write.table(AG_specific_list, file='/Users/loganblair/Desktop/seq/gene_tab_files/AG_biased_gene_list',
            sep='\t',col.names=F,row.names=F)
AG_specific_list=read.delim(file='/Users/loganblair/Desktop/seq/gene_tab_files/AG_biased_gene_list',
                            sep='\t', header=F)
